...
body {background:{color:Background}; color:{color:Text}; font:1em/1.6 {font:Body}; margin:0 0 0 0;}
...
#description {font-family:{font:Body}; font-size:{text:Caption size}; text-align:center; line-height:autopx; margin-bottom:20px; margin-top:-5px;}
...
#posts .post {list-style:none; padding-bottom:26px; max-width:875px;
              clear:both;}
#posts .content {color:{color:Text}; padding:0; margin-left:0px;margin-top:0px;}
...
.meta {{block:IfCenterall}width:875px{/block:IfCenterall}; font-size:14px; text-align:left; line-height:10px;}
...
h3 {font-size:{text:Title size}; line-height:autopx; padding-bottom:25px; font-weight:bold;}

.title_gap
  {margin-top:-6px;}

h4 {font-size:{text:Date size}; line-height:autopx; margin-bottom:0px;  font-family:{font:Date};}
...
blockquote {margin:0 0px 20px;border-left:1px solid {color:line}; padding-left:20px; }
...
.text {width:{text:Caption width}; max-width:875px; margin-bottom:20px; {block:IfCenterall}margin-left:auto; margin-right:auto;{/block:IfCenterall};} 
.caption {width:{text:Caption width}; max-width:875px; margin-bottom:20px; {block:IfCenterall}margin-left:auto; margin-right:auto;{/block:IfCenterall};} 
.nocaption {width:{text:Caption width}; max-width:875px; margin-bottom:-20px; {block:IfCenterall}margin-left:auto; margin-right:auto;{/block:IfCenterall};} 
.vidcaption {width:{text:Caption width}; max-width:875px; margin-top:120px; {block:IfCenterall}margin-left:auto; margin-right:auto;{/block:IfCenterall};}
...
.quote-post .quote {font-family:{font:Body}; font-style:italic;}
...
.short-quote .quote, .medium-quote .quote, .long-quote .quote
  {font-size:{text:Title size}; line-height:autopx; margin:0px 0px 20px 0px;}
...
a.single_links 
{font-family:{font:Body}; display: inline-block; list-style-type: none; margin-right:20px;}
